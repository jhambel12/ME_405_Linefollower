...
- `Line Sensor Mount` - [View Line Sensor Mount](./CAD/Lower_Bracket.STL)  
- `Bump Sensor Mount` - [View Bump Sensor Mount](./CAD/Upper_Bracket.STL)  
- `Bump Sensor Bumper` - [Bump Sensor Bumper](./CAD/Bump_Sensor.STL)  
...
- **Wiring Diagram**
<img src="./wire_diagram/wiringdiagram.png" alt="Wiring Diagram" width="750" />  
...
<img src="./images/Task Diagram.png" alt="Task Diagram" width="800" /> 

Below, state transition diagrams are provided for each of the tasks.
<img src="./images/Task 1 State Diagram.png" alt="Task 1" width="800" /> 
<img src="./images/Task 2 State Diagram.png" alt="Task 2" width="800" /> 
<img src="./images/Task 3 State Diagram.png" alt="Task 3" width="800" /> 
<img src="./images/Task 4 State Diagram.png" alt="Task 4" width="800" /> 
<img src="./images/Task 5 State Diagram.png" alt="Task 5" width="800" /> 
